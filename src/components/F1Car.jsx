...
export const F1Car = ({ isDriving = false, className = '' }) => {
  ...
  return (
    <div className={`f1-car-container ${isDriving ? 'driving' : 'idle'} ${className}`} ref={carRef}>
      <svg className="f1-car-svg" viewBox="0 0 200 60" xmlns="http://www.w3.org/2000/svg">
        {/* Exhaust Flame */}
        <path className="f1-exhaust" d="M10,40 L0,38 L0,42 Z" fill="#00e5ff" />
        
        {/* Chassis / Body */}
        <g className="f1-chassis">
          {/* Rear Wing */}
          <rect x="15" y="15" width="10" height="25" fill="#FF1801" rx="2" />
          <rect x="10" y="10" width="20" height="5" fill="#111" />
          
          {/* Main Body */}
          <path d="M25,40 L160,40 L140,25 L60,25 Z" fill="#FF1801" />
          <path d="M40,25 L100,25 L90,15 L60,15 Z" fill="#b30000" />
          ...
          <path d="M165,30 L190,30 L195,40 L160,40 Z" fill="#FF1801" />
          
          {/* F1 Details / Sponsors */}
          <line x1="70" y1="35" x2="130" y2="35" stroke="#fff" strokeWidth="1" opacity="0.5" />
          <circle cx="120" cy="32" r="3" fill="#00e5ff" />
        </g>
        ...
        <g className="f1-wheel" style={{ transformOrigin: '40px 40px' }}>
          ...
          <circle cx="40" cy="40" r="3" fill="#FF1801" />
          <circle cx="40" cy="40" r="14" fill="none" stroke="#00e5ff" strokeWidth="1.5" opacity="0.8" />
        </g>
        ...
        <g className="f1-wheel" style={{ transformOrigin: '145px 40px' }}>
          ...
          <circle cx="145" cy="40" r="3" fill="#FF1801" />
          <circle cx="145" cy="40" r="12" fill="none" stroke="#00e5ff" strokeWidth="1.5" opacity="0.8" />
        </g>
      </svg>
    </div>
  );
